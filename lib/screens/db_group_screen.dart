...
/// Manage Database connection groups: add, rename, delete. Deleting a group
/// just un-assigns its connections (they become ungrouped), it never
/// deletes connections. Mirrors [HostGroupScreen]
/// (`lib/screens/host_group_screen.dart`) against [DbRepository] instead of
/// [HostRepository].
class DbGroupScreen extends StatefulWidget {
  const DbGroupScreen({super.key});

  @override
  State<DbGroupScreen> createState() => _DbGroupScreenState();
}

class _DbGroupScreenState extends State<DbGroupScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(_s.dbGroups)),
